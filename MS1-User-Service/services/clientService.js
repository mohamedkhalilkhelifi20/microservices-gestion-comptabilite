...
async function createClient({
                                nom, email, telephone, type,
                                matricule_fiscal, cabinet_id, adresse
                            }) {
    ...
    await db.run(
        `INSERT INTO clients
     (id, nom, email, telephone, type,
      matricule_fiscal, cabinet_id, adresse, created_at)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [id, nom, email, telephone, type,
            matricule_fiscal, cabinet_id, adresse, created_at]
    );
